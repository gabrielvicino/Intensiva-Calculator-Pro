...
def render():
    with st.container(border=True):
        ...
        with _v1: st.text_input("BH Acumulado hoje",    key="sis_renal_bacum_hoje",    placeholder="1ª",    label_visibility="collapsed", disabled=True)
        with _v2: st.text_input("BH Acumulado ontem",   key="sis_renal_bacum_ult",     placeholder="2ª",    label_visibility="collapsed", disabled=True)
        with _v3: st.text_input("BH Acumulado antepen", key="sis_renal_bacum_antepen", placeholder="3ª",    label_visibility="collapsed", disabled=True)
        with _v4: st.text_input("BH Acumulado 4o",      key="sis_renal_bacum_ant4",    placeholder="4ª",    label_visibility="collapsed", disabled=True)
        with _v5: st.text_input("BH Acumulado 5o",      key="sis_renal_bacum_ant5",    placeholder="5ª",    label_visibility="collapsed", disabled=True)
